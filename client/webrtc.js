...
function gotRemoteStream(event) {
    ...
    if (remoteVideoCount === 0) {
        ...
        console.log('remoteVideo1 width ', remoteVideo.srcObject.getVideoTracks()[0].getSettings().width);
        console.log('remoteVideo2 height ', remoteVideo.srcObject.getVideoTracks()[0].getSettings().height);
    }
